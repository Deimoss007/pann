...
var tanslate = require('../translate').message;
var request = require('superagent');

module.exports = function (pictures) {
    var el = yo`<div class="container timeline">
                <div class="row">
                    <div class="col s12 m10 offsset-m1 l8 offset-l2 center-align">
    ...
    function toggleButtons() {
        ...
        document.getElementById('fileUpload').classList.toggle('hide');
        document.getElementById('fileCancel').classList.toggle('hide');
